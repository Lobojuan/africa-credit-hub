...
const NplPortfolioDashboardPage = lazy(() => import("@/pages/npl-portfolio-dashboard"));
...
const LotoMessagingAdminPage = lazy(() => import("@/pages/loto-messaging-admin"));
const LotoAdminDashboardPage = lazy(() => import("@/pages/loto-admin-dashboard"));
  ...
  return (
    ...
    <Suspense fallback={<LazyFallback />}>
      <Switch>
        ...
        <Route path="/npl-portfolio-dashboard" component={NplPortfolioDashboardPage} />
          ...
          {isMobile ? (
            <header className="flex items-center justify-between px-3 py-2 border-b shrink-0 ltr-header h-14">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-bold tracking-tight truncate max-w-[140px]" data-testid="text-mobile-brand">Universal Credit Hub</span>
              </div>
