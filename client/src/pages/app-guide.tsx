...
const GUIDES: GuideSection[] = [
  {
    ...
    steps: [
      { title: "Open the login page", description: "Navigate to the platform URL. Enter your username and password, then click Sign In. You can also use Google, Microsoft, Apple, or Enterprise SSO.", path: "/" },
      { title: "Enable MFA for extra security", description: "After logging in, click your avatar in the top-right → Profile Settings → Enable MFA. Scan the QR code with any authenticator app (Google Authenticator, Authy, etc.) and save your backup codes.", tip: "MFA is strongly recommended — your account holds sensitive credit data." },
  ...
  },
  {
    ...
    steps: [
      ...
      { title: "Generate a credit report", description: "From any borrower's detail page, click 'Generate Credit Report'. The D&B-style report includes a credit profile overview, liability breakdown, aging analysis, and 24-month payment grid.", tip: "PDF reports are available in all 5 languages. Each report gets a unique serial number for audit tracking." },
