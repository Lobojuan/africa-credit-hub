...
const CREDIT_BUREAU_FRAMEWORK: Record<string, string> = {
  ...
  SL: "Universal Credit Hub Pan-African Registry",
    ...
    <div className="min-h-screen bg-background flex flex-col">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
              ...
              <KPICard icon={Shield} label="System Version" value={platform?.systemVersion ?? "Universal Credit Hub v2.8"} sub="Pan-African Registry" color="bg-muted-foreground/20" />
            </div>
          </div>
      ...
      <footer className="px-4 py-3 border-t border-border flex items-center justify-between">
        <p className="text-[10px] text-muted-foreground">
          Universal Credit Hub v2.8 | Secured by {PLATFORM_COMPANY_NAME}
        </p>
        <div className="flex items-center gap-1.5">
