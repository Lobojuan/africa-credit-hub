              ...
              <table className="w-full text-xs border-collapse">
                ...
                <tbody className="divide-y divide-border/50">
                  {[
                    ...
                    {
                      feature: "ML Predictive Default Risk",
                      us: "✓ African-market ML model",
                      experian: "⚠ Western models only",
                      transunion: "⚠ Western models only",
                      equifax: "✗ N/A for Africa",
                      usGood: true, exGood: null, tuGood: null, eqGood: false,
                    },
                    {
                      feature: "Collateral Verification (DVLA / Lands)",
                      us: "✓ Native DVLA & Lands Commission",
                      experian: "✗ Not for Africa",
                      transunion: "✗ Not for Africa",
                      equifax: "✗ N/A",
                      usGood: true, exGood: false, tuGood: false, eqGood: false,
                    },
                    {
                      feature: "African Open Banking Providers",
                      us: "✓ MTN MoMo, Flutterwave, GCB & more",
                      experian: "✗ None",
                      transunion: "✗ None",
                      equifax: "✗ None",
                      usGood: true, exGood: false, tuGood: false, eqGood: false,
                    ...
                    {
                      feature: "Cross-Lender Risk Alerts",
                      us: "✓ Real-time across all lenders",
                      experian: "✗ Siloed per contract",
                      transunion: "✗ Siloed per contract",
                      equifax: "✗ N/A",
                      usGood: true, exGood: false, tuGood: false, eqGood: false,
                    },
                    {
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-14">
            {[
              ...
              },
              {
                ...
                desc: "While incumbents retrofit AI onto 30-year-old mainframes, our AI Command Center, Portfolio Intelligence, ML Predictive Default Risk model, and real-time Cross-Lender Risk Alerts were built into the architecture from the ground up — trained on African credit data.",
              ...
              },
              {
                ...
                desc: "Studies show African lenders cannot score 70%+ of applicants using traditional bureau data alone (Credolab, 2024). Our Telco Scoring and Open Banking modules ingest MTN MoMo, Flutterwave, GCB, and Orange Money data — extending credit visibility to thin-file borrowers incumbents cannot assess.",
                ...
                <CardContent className="pt-5 pb-5">
                  ...
                  <ul className="space-y-2.5">
                    {[
                      ...
                      { item: "BoG, BSL, CBK & CBN regulatory exports built-in", note: "Kenya, Nigeria, Ghana, Sierra Leone — automated, no dev work" },
                      { item: "ML predictive default risk scoring", note: "African-trained model; 90-day probability of default on every borrower" },
                      { item: "DVLA & Lands Commission collateral verification", note: "live vehicle and land-title checks at point of origination" },
                      { item: "African open banking providers included", note: "MTN MoMo, Flutterwave, GCB, Orange Money — no extra integration" },
