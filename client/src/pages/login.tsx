                ...
                <form onSubmit={handleMfaSubmit} className="space-y-4" data-testid="form-mfa-login">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="text-right">
                      <a href="/forgot-password" className="text-xs font-medium text-blue-700 hover:underline">Forgot your password?</a>
                    </div>
                  </div>
                  <button
                    type="submit"
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              {[
                ...
                <div key={testid} className="relative">
                  ...
                  <span
                    className="absolute -top-2 -right-1 text-[9px] font-semibold px-1.5 py-0.5 rounded-full leading-none pointer-events-none"
                    style={{
