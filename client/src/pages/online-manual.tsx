...
const helpSections: HelpSection[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "Q: How many currencies are supported? — 17 currencies: ETB, GHS, UGX, LRD, USD, EUR, GBP, KES, TZS, RWF, NGN, ZAR, XOF, XAF, EGP, MAD, CNY.",
      "Q: What are the supported jurisdictions? — Ghana, Ethiopia, Uganda, and Liberia.",
      "Q: How do I switch between English and French? — Use the language switcher (globe icon) in the top header bar.",
