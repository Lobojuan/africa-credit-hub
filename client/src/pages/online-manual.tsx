  ...
  return [
    {
      ...
      steps: [
        ...
        t("manual.gettingStarted.s3", "Alternatively, sign in using Google (active) or a registered Passkey — click 'Sign in with Passkey' after entering your username to use Touch ID, Face ID, or a hardware security key. Microsoft, Apple, and Enterprise SSO are coming soon."),
        ...
        t("manual.gettingStarted.s5", "After login, secure your account with two-factor authentication: click 'Enable MFA' in the top header to set up TOTP (scan the QR code with Google Authenticator, Authy, or any authenticator app), or click 'Passkey' to register your device biometric (Touch ID / Face ID) for password-free login."),
        t("manual.gettingStarted.s6", "Use the language switcher in the top header to toggle between eight languages — English, French, Portuguese, Arabic, Swahili, Spanish, Simplified Chinese, and Traditional Chinese."),
    ...
    },
    {
      ...
      steps: [
        ...
        t("manual.creditSearch.s10", "PDF reports can be downloaded in all eight languages using the language selector."),
    ...
    },
    {
      ...
      steps: [
        ...
        t("manual.documents.s3", "All documents are available in eight languages (EN, FR, PT, AR, SW, ES, ZH-S, ZH-T) and can be downloaded as PDF or Markdown."),
    ...
    },
    {
      ...
      steps: [
        ...
        t("manual.faq.s2", "Q: How do I enable MFA? — After login, click the 'Enable MFA' button in the top navigation header. A dialog opens with a scannable QR code — scan it with Google Authenticator, Microsoft Authenticator, Authy, or 1Password. Enter the 6-digit code to confirm."),
        ...
        t("manual.faq.s12", "Q: What social login options are available? — Google is fully active. Microsoft, Apple, and Enterprise SSO (SAML) are listed as coming soon."),
        ...
        t("manual.faq.s15", "Q: How do I set up and use a Passkey (Touch ID / Face ID)? — After logging in, click the 'Passkey' button in the top navigation header. Your browser will prompt you to register a biometric credential (fingerprint, face scan, or hardware security key). Once registered, return to the login page, enter your username, and click 'Sign in with Passkey' — no password needed. Each device must be registered separately."),
        t("manual.faq.s16", "Q: Can I use both MFA and a Passkey? — Yes, they are independent security methods. MFA (TOTP) adds a time-based code step after password entry. A Passkey replaces the password entirely with a biometric. You can have both active simultaneously for maximum flexibility."),
      ],
    },
  ];
}
...
const roleAccessMatrix = [
  ...
  { moduleKey: "creditAccounts", desc: "Full lifecycle management of loan and credit facility records. Log disbursements, repayments, restructurings, and closures. Each account links to a borrower, institution, and product type. Powers the UCH credit score calculations and BoG pipe-delimited exports.", super_admin: true, admin: true, regulator: true, lender: true, viewer: true },
  ...
  { moduleKey: "telco", desc: "Telco-derived alternative credit scoring using mobile money transaction patterns, airtime usage, and SIM registration data. Generates a supplementary Telco Score alongside the core UCH Scorecard — particularly valuable for thin-file and unbanked borrowers. Not available to read-only viewers.", super_admin: true, admin: true, regulator: true, lender: true, viewer: false },
  ...
  { moduleKey: "userManagement", desc: "Create, edit, deactivate, and assign roles to platform users within your institution. Users can self-enrol TOTP MFA (QR code setup) and register passkeys (WebAuthn biometric login) from the top navigation header. Admins manage their own institution's users; super admins manage all institutions.", super_admin: true, admin: true, regulator: false, lender: false, viewer: false },
