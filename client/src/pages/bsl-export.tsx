...
export default function BslExportPage() {
  ...
  const [exportHistory, setExportHistory] = useState<Array<{
    ...
    try {
      return JSON.parse(sessionStorage.getItem("bsl_export_history") || "[]");
    } catch { return []; }
  });
  ...
  async function handleDownload() {
    ...
    try {
      ...
      setExportHistory(prev => {
        ...
        sessionStorage.setItem("bsl_export_history", JSON.stringify(updated));
        return updated;
      });
    } catch (e: any) {
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Button
                ...
                onClick={() => {
                  setExportHistory([]);
                  sessionStorage.removeItem("bsl_export_history");
                }}
