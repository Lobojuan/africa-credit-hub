...
function StatusBadge({ status }: { status: string }) {
  ...
  const variants: Record<string, string> = {
    ...
    paid: "bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 dark:bg-green-900 dark:text-green-200",
    overdue: "bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-200 dark:bg-red-900 dark:text-red-200",
  };
  return (
