    ...
    <div className="p-6 space-y-6 max-w-[1400px] mx-auto">
      <div>
        <div className="flex items-center gap-2 mb-1">
          ...
          <h1 className="text-2xl font-extrabold tracking-tight" data-testid="text-helpdesk-title">
            {t("helpdesk.title")}
          </h1>
        </div>
        <p className="text-sm text-muted-foreground ml-4">{t("helpdesk.subtitle")}</p>
      </div>
