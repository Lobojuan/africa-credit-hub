...
export const PRODUCT_REGISTRY: Record<ProductId, ProductDefinition> = {
  ...
  loto: {
    ...
    englishTagline: "VAT receipts that build credit — fiscal data turned into bankability",
    descKey: "products.loto.desc",
    englishDesc:
      "Verified VAT receipts power a merchant credit profile, prove consumer spending capacity, and give the tax authority real-time receipt visibility — all under one explicit, time-bounded consent.",
    routePrefix: "/loto",
    publicLanding: "/loto",
