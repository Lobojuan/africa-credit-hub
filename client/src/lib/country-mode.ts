...
const COUNTRY_REGISTRY: Record<string, CountryConfig> = {
  ...
  cotedivoire: {
    ...
    theme: {
      ...
      sidebar: "213 50% 11%",
      sidebarForeground: "0 0% 95%",
      sidebarBorder: "213 45% 17%",
      sidebarPrimary: "48 88% 52%",
      sidebarAccent: "213 45% 17%",
      accent: "48 88% 52%",
      ring: "213 72% 35%",
      chart1: "213 72% 35%",
      chart2: "48 88% 52%",
      logoGradientFrom: "hsl(213 72% 45%)",
      logoGradientTo: "hsl(48 88% 44%)",
      logoGlow: "hsl(213 72% 45% / 0.4)",
    },
  },
  senegal: {
    name: "Senegal",
    ...
    regions: [
      ...
      "Kaolack", "Ziguinchor", "Louga", "Fatick", "Kolda", "Matam", "Kédougou",
    ],
    theme: {
      primary: "197 75% 34%",
      primaryForeground: "0 0% 98%",
      sidebar: "197 55% 11%",
      sidebarForeground: "0 0% 95%",
      sidebarBorder: "197 50% 17%",
      sidebarPrimary: "0 80% 50%",
      sidebarAccent: "197 50% 17%",
      accent: "0 80% 50%",
      ring: "197 75% 34%",
      chart1: "197 75% 34%",
      chart2: "0 80% 50%",
      logoGradientFrom: "hsl(197 75% 44%)",
      logoGradientTo: "hsl(0 80% 42%)",
      logoGlow: "hsl(197 75% 44% / 0.4)",
    },
  },
  cameroon: {
    name: "Cameroon",
    ...
    theme: {
      ...
      sidebar: "0 55% 12%",
      sidebarForeground: "0 0% 95%",
      sidebarBorder: "0 50% 18%",
      sidebarPrimary: "52 80% 50%",
      sidebarAccent: "0 50% 18%",
      accent: "52 80% 50%",
      ring: "145 60% 28%",
      chart1: "145 60% 28%",
      chart2: "52 80% 50%",
      logoGradientFrom: "hsl(145 60% 38%)",
      logoGradientTo: "hsl(0 55% 35%)",
      logoGlow: "hsl(145 60% 38% / 0.4)",
    },
  },
  morocco: {
    name: "Morocco",
    ...
    theme: {
      ...
      sidebarForeground: "0 0% 95%",
      sidebarBorder: "145 30% 16%",
      sidebarPrimary: "45 85% 52%",
      sidebarAccent: "145 30% 16%",
      accent: "45 85% 52%",
      ring: "0 75% 35%",
      chart1: "0 75% 35%",
      chart2: "45 85% 52%",
      logoGradientFrom: "hsl(0 75% 45%)",
      logoGradientTo: "hsl(145 35% 25%)",
      logoGlow: "hsl(0 75% 45% / 0.4)",
    },
  },
};
