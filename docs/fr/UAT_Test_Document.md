...
39. [Module d'Analyses Visuelles du Tableau de Bord (ENT-14)](#39-module-danalyses-visuelles-du-tableau-de-bord-ent-14)
40. [Module de Visite Guidée Interactive de Démonstration (ENT-15)](#40-module-de-visite-guidée-interactive-de-démonstration-ent-15)
...
| Améliorations Entreprise | MFA, Correspondance Floue, Chatbot de Litiges, OAuth 2.1, Faible Bande Passante, Téléchargement XBRL, Audit Inviolable, Gestion des Taux de Change, Administration API, Politiques de Rétention des Données, Recherche Globale, Photos d'Identité et Documents, Environnement de Démonstration, Analyses Visuelles du Tableau de Bord, Visite Guidée Interactive |
...
## 39. Module d'Analyses Visuelles du Tableau de Bord (ENT-14)

| ID-CT | Module | Nom du Cas de Test | Pré-conditions | Étapes de Test | Résultat Attendu | Réussi/Échoué | Référence SRS |
|-------|--------|-------------------|----------------|----------------|------------------|---------------|---------------|
| TC-VIZ-001 | Analyses Visuelles | Le graphique en aire de croissance du portefeuille se charge avec 12 mois de données | L'utilisateur est connecté, des données de tableau de bord existent | 1. Naviguer vers le Tableau de Bord (`/`). 2. Faire défiler jusqu'à la section du graphique de Croissance du Portefeuille. 3. Observer le graphique en aire. | Le graphique en aire s'affiche avec 12 mois de points de données montrant les tendances des emprunteurs et des comptes au fil du temps. L'axe X affiche les mois, l'axe Y affiche les quantités. Le graphique est rendu à l'aide de la bibliothèque Recharts. | | ENT-14 |
| TC-VIZ-002 | Analyses Visuelles | Infobulles du graphique en aire au survol | L'utilisateur est connecté, le graphique de croissance du portefeuille est visible | 1. Naviguer vers le Tableau de Bord. 2. Survoler un point de données sur le graphique en aire de croissance du portefeuille. | Une infobulle apparaît affichant le libellé du mois, le nombre d'emprunteurs et le nombre de comptes pour le point de données survolé. | | ENT-14 |
| TC-VIZ-003 | Analyses Visuelles | Le graphique en anneau des statuts de comptes affiche toutes les catégories | L'utilisateur est connecté, des comptes de crédit avec différents statuts existent | 1. Naviguer vers le Tableau de Bord. 2. Localiser le graphique en anneau des Statuts de Compte. 3. Observer tous les segments affichés. | Le graphique en anneau s'affiche avec des segments pour toutes les catégories de statut de compte (en cours, en souffrance, en défaut, fermé, restructuré, passé en perte). Chaque segment est coloré et étiqueté. | | ENT-14 |
| TC-VIZ-004 | Analyses Visuelles | Le graphique en barres horizontales des types de prêts affiche les principaux types de comptes | L'utilisateur est connecté, des comptes de crédit avec différents types existent | 1. Naviguer vers le Tableau de Bord. 2. Localiser le graphique de répartition par Type de Prêt. 3. Observer le graphique en barres horizontales. | Le graphique en barres horizontales s'affiche montrant les principaux types de comptes (par ex., prêt_personnel, hypothèque, prêt_commercial). Les barres sont proportionnelles au nombre de chaque type. | | ENT-14 |
| TC-VIZ-005 | Analyses Visuelles | La carte de l'Afrique affiche les 54 pays | L'utilisateur est connecté | 1. Naviguer vers le Tableau de Bord. 2. Faire défiler jusqu'à la section Carte de l'Afrique. 3. Observer la carte SVG. | La carte choroplèthe SVG s'affiche montrant les 54 pays africains. Chaque pays est une région distincte, cliquable/survolable. | | ENT-14 |
| TC-VIZ-006 | Analyses Visuelles | La coloration thermique de la carte reflète les niveaux d'activité des emprunteurs | L'utilisateur est connecté, des données d'emprunteurs existent dans plusieurs pays | 1. Naviguer vers le Tableau de Bord. 2. Observer le code couleur de la carte de l'Afrique. 3. Comparer les couleurs avec la légende. | Les pays avec une activité d'emprunteurs plus élevée affichent une coloration thermique plus foncée/intense. Les pays sans activité affichent une couleur neutre/claire. Une légende est visible montrant l'échelle de couleurs des niveaux d'activité. | | ENT-14 |
| TC-VIZ-007 | Analyses Visuelles | Les infobulles de la carte au survol affichent les détails du pays | L'utilisateur est connecté, la carte de l'Afrique est visible | 1. Naviguer vers le Tableau de Bord. 2. Survoler un pays sur la carte de l'Afrique. | Une infobulle apparaît affichant le nom du pays, le nombre d'emprunteurs et le nombre de comptes pour ce pays. | | ENT-14 |
| TC-VIZ-008 | Analyses Visuelles | Les graphiques s'affichent correctement en mode sombre | L'utilisateur est connecté, le mode sombre est activé | 1. Basculer le thème en mode sombre. 2. Naviguer vers le Tableau de Bord. 3. Observer tous les graphiques (aire, anneau, barres) et la carte de l'Afrique. | Tous les graphiques s'adaptent au mode sombre avec des couleurs d'arrière-plan, d'axes, de libellés et de style d'infobulles appropriés. Les graphiques restent lisibles et visuellement cohérents avec le thème sombre. | | ENT-14 |
| TC-VIZ-009 | Analyses Visuelles | Le point d'accès API des données de graphiques nécessite une authentification | Aucune session active | 1. Ouvrir un nouvel onglet de navigateur ou utiliser un client API. 2. Envoyer une requête GET à `/api/dashboard/chart-data` sans authentification. | La requête retourne 401 Non Autorisé. Les données de graphiques ne sont pas exposées aux utilisateurs non authentifiés. | | ENT-14, NFR-SEC-01 |
| TC-VIZ-010 | Analyses Visuelles | Les graphiques sont réactifs sur les fenêtres mobiles | L'utilisateur est connecté | 1. Ouvrir les outils de développement du navigateur. 2. Définir la fenêtre à une taille mobile (par ex., 375x667). 3. Naviguer vers le Tableau de Bord. 4. Faire défiler toutes les sections de graphiques. | Tous les graphiques se redimensionnent de manière réactive pour s'adapter à la fenêtre mobile. Les graphiques restent lisibles sans défilement horizontal. Les légendes et libellés s'ajustent de manière appropriée. | | ENT-14 |

---

## 40. Module de Visite Guidée Interactive de Démonstration (ENT-15)

| ID-CT | Module | Nom du Cas de Test | Pré-conditions | Étapes de Test | Résultat Attendu | Réussi/Échoué | Référence SRS |
|-------|--------|-------------------|----------------|----------------|------------------|---------------|---------------|
| TC-TOUR-001 | Visite Guidée | La visite se lance automatiquement après la connexion démo | L'application est accessible | 1. Naviguer vers la page de connexion. 2. Cliquer sur le bouton « Essayer la Démo Interactive ». 3. Sélectionner un rôle démo (par ex., Admin). 4. Attendre que le Tableau de Bord se charge. | Après la connexion démo, la visite guidée se lance automatiquement. Une surcouche projecteur apparaît mettant en surbrillance la première étape de la visite. L'indicateur sessionStorage déclenche le lancement automatique. | | ENT-15 |
| TC-TOUR-002 | Visite Guidée | La visite comporte 11 étapes avec surcouche projecteur | La visite est active (depuis TC-TOUR-001) | 1. Observer la surcouche de la visite. 2. Cliquer sur « Suivant » à travers toutes les étapes. 3. Compter le nombre total d'étapes. | La visite contient exactement 11 étapes. Chaque étape affiche une surcouche projecteur mettant en surbrillance un élément spécifique de l'interface (navigation dans la barre latérale, cartes de statistiques, graphiques, carte de l'Afrique, recherche, paramètres, etc.). Le compteur d'étapes affiche la progression (par ex., « Étape 1 sur 11 »). | | ENT-15 |
| TC-TOUR-003 | Visite Guidée | Les contrôles Suivant/Précédent/Passer/Fermer fonctionnent | La visite est active | 1. Cliquer sur « Suivant » pour avancer à l'étape 2. 2. Cliquer sur « Précédent » pour revenir à l'étape 1. 3. Cliquer sur « Suivant » pour avancer à nouveau. 4. Cliquer sur « Passer » pour terminer la visite prématurément. 5. Relancer la visite. 6. Cliquer sur « Fermer » (bouton X) pour fermer. | Suivant avance à l'étape suivante. Précédent revient à l'étape précédente. Passer termine la visite immédiatement et ferme la surcouche. Fermer (X) ferme la surcouche de la visite. Tous les contrôles répondent correctement. | | ENT-15 |
| TC-TOUR-004 | Visite Guidée | Le bouton « Faire la Visite » relance la visite | L'utilisateur est connecté via la démo, la visite a été précédemment terminée ou passée | 1. Terminer ou passer la visite initiale. 2. Localiser la bannière ambre ENVIRONNEMENT DE DÉMONSTRATION en haut de la page. 3. Cliquer sur le bouton « Faire la Visite » dans la bannière. | La visite se relance depuis l'étape 1. La surcouche projecteur réapparaît. La visite complète en 11 étapes est disponible. | | ENT-15 |
| TC-TOUR-005 | Visite Guidée | La visite fonctionne dans les 5 langues de l'UA | L'utilisateur est connecté via la démo | 1. Définir la langue en Français (FR). 2. Lancer la visite. Observer que le texte de la visite est en français. 3. Répéter pour le Portugais (PT), l'Arabe (AR) et le Swahili (SW). | Les titres et descriptions des étapes de la visite sont traduits dans la langue sélectionnée. Les 5 langues de l'UA (EN, FR, PT, AR, SW) affichent correctement le contenu traduit de la visite. | | ENT-15 |
| TC-TOUR-006 | Visite Guidée | La visite gère correctement la barre latérale mobile | L'utilisateur est connecté via la démo, fenêtre mobile | 1. Définir la fenêtre à une taille mobile. 2. Lancer la visite de démonstration. 3. Observer le comportement de la visite lors de la mise en surbrillance des éléments de la barre latérale. | Sur les fenêtres mobiles, la visite gère correctement la barre latérale rétractable. Si une étape de la visite met en surbrillance un élément de la barre latérale, la barre latérale s'ouvre automatiquement ou l'étape s'adapte à la disposition mobile. La visite reste utilisable sur mobile. | | ENT-15 |
