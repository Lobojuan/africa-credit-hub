...
4. Provision a least-privilege sandbox user or SSO identity. Do not exchange shared credentials, API keys or production secrets in email, chat or source control.
5. Run the UAT cases in [`Bank_Pilot_Launch_Pack.md`](Bank_Pilot_Launch_Pack.md) and record all exceptions.
6. Obtain written security, privacy, risk and business acceptance before any production connection request.
