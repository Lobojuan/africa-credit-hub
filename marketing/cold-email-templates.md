...
## 1. To a bank or MFI head of risk / credit

**Subject:** Pan-African credit reports + VAT-receipt scoring (90 sec read)
...
The fiscal-receipt piece is the unlock — it lets you safely lend to thin-file merchants who'd previously be auto-declined.
...
## 2. To a central-bank / supervisor official

**Subject:** Real-time supervisory window for [Country] credit data — sandbox in 5 days
...
We can stand up an isolated sandbox with anonymised data for your team in 5 business days, with read-only supervisor accounts and an export tailored to your existing reporting schema. No commitment.

May I send a one-page brief and a 20-minute walkthrough slot?
...
## 3. To a fintech VC partner

**Subject:** Pan-African credit infrastructure — quick check-in?

Hi [Name],

You've written about the African SME financing gap [referencing a specific post / portfolio investment / panel — be specific].

Quick line on what we're building:

We're a single platform combining a pan-African credit bureau, a movable-asset collateral registry, and a fiscal-receipt scoring system (Loto Fiscal) — all wired through a consent-bounded data bridge. The architectural unlock is that 300M+ thin-file merchants who today are unfundable become a credit profile their lender can read.

Live, deployed, six regulator export templates already shipped (BoG, CBN, BCEAO, BEAC, CBK, BSL). Raising a [seed / series A] of $[X]M to onboard 25 pilot lenders and close two central-bank sandbox deployments.
...
## 4. To a journalist (TechCrunch Africa / Disrupt Africa / Rest of World / FT Africa)

**Subject:** Story idea — the credit-bureau architecture Africa actually needs
...
## 5. To an African accelerator / hub (Catalyst Fund, Norrsken, Future Africa, Founders Factory Africa)

**Subject:** Partnering on financial-inclusion infrastructure
...
2. Co-run a financial-inclusion case study using anonymised pilot data
...
## 6. To a peer founder (warm)

**Subject:** Built a thing — want your eyes on it
...
- **Send Tuesday–Thursday, 7–9 AM** local recipient time. Avoid Mondays and Fridays.
- **One ask per email.** Demo, intro call, exclusive — pick one.
- **Personalize the first line.** If you can't, don't send it.
- **Follow up after 4 business days** with a one-line bump: "Bumping this up — happy to send the 90-second demo regardless." Then again at day 10. Then drop it.
- **Track opens** with a simple link UTM, not pixel trackers (they trip spam filters).
