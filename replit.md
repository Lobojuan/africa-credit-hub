...
-   **Core Capabilities**:
    ...
    -   **Investor Landing Page**: Premium investor-facing page (`/investor`) with AI-generated images, animated counters, platform module deep-dive, competitive advantages, and technology architecture sections. Features one-click demo launch via auto-login (`/api/auth/auto-login/:token`) that bypasses login form entirely. Consumer portal link also available.
