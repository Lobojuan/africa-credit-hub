...
-   **Core Capabilities**:
    ...
    -   **Transaction-Based Monetization**: Per-transaction billing with volume tier discounts. Schema tables: `usage_metering` (tracks billable events per org), `pricing_tiers` (11 seeded tiers — credit reports $1.50–$2.50, API calls $0.05–$0.10, batch uploads $3.50–$5.00, cross-border queries $3.50, disputes $1.00, data exports $2.00). Unbilled usage accumulates for monthly invoicing. Pricing tiers editable via Billing tab.
