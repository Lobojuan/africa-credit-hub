...
export async function seedDatabase() {
  ...
  const [admin] = await db.insert(users).values([
    { username: "admin", password: "admin123", fullName: "Tadesse Bekele", email: "tadesse@nbe.gov.et", role: "admin", status: "active", institution: "National Bank of Ethiopia" },
    { username: "regulator1", password: "reg123", fullName: "Almaz Haile", email: "almaz@nbe.gov.et", role: "regulator", status: "active", institution: "National Bank of Ethiopia" },
    { username: "cbe_user", password: "cbe123", fullName: "Yohannes Gebre", email: "yohannes@cbe.com.et", role: "lender", status: "active", institution: "Commercial Bank of Ethiopia" },
    { username: "dashen_user", password: "dashen123", fullName: "Sara Mengistu", email: "sara@dashenbank.com.et", role: "lender", status: "active", institution: "Dashen Bank" },
    { username: "awash_user", password: "awash123", fullName: "Kebede Worku", email: "kebede@awashbank.com", role: "lender", status: "active", institution: "Awash International Bank" },
  ]).returning();
  ...
  const createdBorrowers = await db.insert(borrowers).values([
    {
      ...
      dateOfBirth: "1985-03-15", gender: "Male", phone: "+251911234567",
    ...
    },
    {
      ...
      dateOfBirth: "1990-07-22", gender: "Female", phone: "+251922345678",
    ...
    },
    {
      ...
      dateOfBirth: "1978-11-30", gender: "Male", phone: "+251933456789",
    ...
    },
    {
      ...
      phone: "+251115572000", email: "info@habeshabreweries.com",
    ...
    },
    {
      ...
      phone: "+251115518300", email: "anbessa@transport.gov.et",
  ...
  await db.insert(creditAccounts).values([
    ...
    },
    {
      ...
      originalAmount: "15000000.00", currentBalance: "3200000.00", currency: "ETB",
  ...
  await db.insert(creditInquiries).values([
    ...
    { borrowerId: createdBorrowers[2].id, inquiredBy: admin.id, purpose: "regulatory", institution: "National Bank of Ethiopia", consentProvided: true },
  ...
  await db.insert(auditLogs).values([
    { userId: admin.id, action: "LOGIN", entity: "system", details: "Admin user logged in" },
    { userId: admin.id, action: "SEARCH", entity: "borrower", details: "Searched for borrower: Abebe Tesfaye" },
    { userId: admin.id, action: "VIEW", entity: "credit_report", entityId: createdBorrowers[0].id, details: "Viewed credit report" },
    { userId: admin.id, action: "CREATE", entity: "borrower", entityId: createdBorrowers[3].id, details: "Registered corporate borrower: Habesha Breweries" },
  ]);
