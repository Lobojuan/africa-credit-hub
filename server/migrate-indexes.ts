...
export async function createPerformanceIndexes() {
  const indexes = [
    ...
    `CREATE INDEX IF NOT EXISTS idx_borrowers_country_created_at ON borrowers (country, created_at DESC)`,
    `CREATE INDEX IF NOT EXISTS idx_borrowers_org_country ON borrowers (organization_id, country)`,
    ...
    `CREATE INDEX IF NOT EXISTS idx_credit_accounts_borrower ON credit_accounts (borrower_id)`,
    ...
    `CREATE INDEX IF NOT EXISTS idx_credit_accounts_org_status ON credit_accounts (organization_id, status)`,
    ...
    `CREATE INDEX IF NOT EXISTS idx_credit_inquiries_borrower_created_at ON credit_inquiries (borrower_id, created_at DESC)`,
    `CREATE INDEX IF NOT EXISTS idx_court_judgments_borrower_created_at ON court_judgments (borrower_id, created_at DESC)`,
    `CREATE INDEX IF NOT EXISTS idx_disputes_borrower_id ON disputes (borrower_id)`,
    `CREATE INDEX IF NOT EXISTS idx_disputes_status ON disputes (status)`,
    `CREATE INDEX IF NOT EXISTS idx_disputes_org_country_status ON disputes (organization_id, country, status)`,
    ...
    `CREATE INDEX IF NOT EXISTS idx_payment_history_account_period ON payment_history (credit_account_id, period DESC)`,
