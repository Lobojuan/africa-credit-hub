...
const EXPORT_AUTHORSHIP = {
  platform: `${process.env.PLATFORM_COMPANY_NAME || "Universal Credit Hub"} (UCH v2.8)`,
  author: process.env.PLATFORM_ADMIN_NAME || "Platform Administrator",
  company: process.env.PLATFORM_COMPANY_NAME || "Universal Credit Hub",
  registryRef: process.env.PLATFORM_REGISTRY_REF || "UCH-2026-001",
  copyright: `© ${new Date().getFullYear()} ${process.env.PLATFORM_COMPANY_NAME || "Universal Credit Hub"}. All rights reserved.`,
